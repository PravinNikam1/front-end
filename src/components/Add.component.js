...
const Addcomponent = () => {
  ...
  const [item, setItem] = useState({
    title: "",
    description: "", //through descripotion we are taking date here
    quantity: "",
    weight: "",
    ...
    <div className="alert alert-success p-1" role="alert">
      <div className="register-container p-1">
        ...
        <label htmlFor="username">E Waste Name</label>
          ...
          {/* through the description we are taking the Pick up date from the user */}
          <div className="form-group ">
          ...
          <button type="submit" className="btn btn-success my-1 mx-1" onClick={() => setSmShow(false)}>
            Add Record
          </button>
        </form>
      </div>
